...
// normal routes ===============================================================
    ...
    // decode URI Date somewhere around here
    // Got this code from Sherrell and Michael
    // const current = result.find((item) => item.date === decodeURIComponent(req.query.date))
...
// message board routes ===============================================================
    ...
    app.post('/messages', (req, res) => {
      db.collection('messages').save({name: req.body.name, msg: req.body.msg, date:req.body.date, entry1: req.body.entry1, archive: req.body.archive}, (err, result) => {
        if (err) return console.log(err)
    ...
    app.put('/messages', (req, res) => {
      let thumbLogic
      const archive = Object.keys(req.body).includes('archive')
